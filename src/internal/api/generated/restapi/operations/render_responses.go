...
/*RenderOK The server successfully processed the request and is not returning any content.
...
/*RenderDefault Generic error response.
...
// WithPayload adds the payload to the render default response
func (o *RenderDefault) WithPayload(payload *models.Error) *RenderDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the render default response
func (o *RenderDefault) SetPayload(payload *models.Error) {
	o.Payload = payload
}
